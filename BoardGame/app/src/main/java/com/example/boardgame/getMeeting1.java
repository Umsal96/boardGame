...
public class getMeeting1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        moreMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PopupMenu popupMenu = new PopupMenu(getMeeting1.this, v); // 팝업메뉴 등록
        ...
        backPage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 메인 페이지로 이동
                Intent intent1 = new Intent(getMeeting1.this, main.class);
    ...
    private void showDeleteDialog(int id){
        AlertDialog.Builder builder = new AlertDialog.Builder(getMeeting1.this);
        builder.setTitle("경고");
    ...
    private void delete(int id){
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                ...
                Intent intent = new Intent(getMeeting1.this, main.class);
