...
public class inputCafeReview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_input_cafe_review);
        ...
        backPage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(inputCafeReview.this, getCafe.class);
...
//                            totalPage.setText(String.valueOf(imageDataList.size()));
    ...
    private void input(int cafeId, int userId){
        HttpUrl.Builder urlBuilder = HttpUrl.parse("http://3.38.213.196/cafeReview/inputCafeReview.php").newBuilder();
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                if(response.isSuccessful()){
                    ...
                    Intent intent = new Intent(inputCafeReview.this, getCafe.class);
