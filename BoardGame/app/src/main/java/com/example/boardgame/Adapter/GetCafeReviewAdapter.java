...
public class GetCafeReviewAdapter extends RecyclerView.Adapter<GetCafeReviewAdapter.ViewHolder> {
    private ArrayList<CafeReviewItem> cafeItems;
    ...
    public GetCafeReviewAdapter(ArrayList<CafeReviewItem> DataSet, int userId){
        this.cafeItems = DataSet;
        this.userId = userId;
    }

    public void setData(ArrayList<CafeReviewItem> DataSet){
        this.cafeItems = DataSet;
    }

    @NonNull
    @Override
    public GetCafeReviewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType){
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.game_review_item, parent, false);
        GetCafeReviewAdapter.ViewHolder viewHolder = new GetCafeReviewAdapter.ViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(@NonNull GetCafeReviewAdapter.ViewHolder holder, int position){
        CafeReviewItem item = cafeItems.get(position);
